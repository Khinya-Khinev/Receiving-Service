...
public class User implements UserDetails {
    ...
    public static User createWorker(RegisterUserRequest request, String encodedPassword) {
        return new User(
                request,
                encodedPassword,
                Authority.WORKER
    ...
    public static User createManager(RegisterUserRequest request, String encodedPassword) {
        return new User(
                request,
                encodedPassword,
                Authority.MANAGER
